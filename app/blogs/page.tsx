      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-gray-400 font-black uppercase tracking-widest text-xs">Loading Blogs...</p>
          </div>
        ) : filteredBlogs.length === 0 ? (
          <div className="text-center py-20 bg-[#FAF9FF] rounded-3xl border border-[#F5F3FF]">
            <p className="text-gray-400 font-bold uppercase tracking-widest">No blogs available yet. Stay tuned!</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between mb-3 gap-2">
                    {blog.category && (
                      <span className="text-[10px] font-black uppercase tracking-widest text-[#A855F7] bg-purple-50 px-3 py-1 rounded-full">
                        {blog.category}
                      </span>
                    )}
                  ...
                  {/* Title */}
                  <h3 className="font-black text-gray-900 mb-3 uppercase tracking-tight text-lg line-clamp-2">
                    {blog.title}
                  </h3>
                  ...
                  {blog.tags && blog.tags.length > 0 && (
                    <div className="flex flex-wrap gap-2 mb-4">
                      {blog.tags.slice(0, 3).map((tag, idx) => (
                        <span key={idx} className="text-[9px] font-bold uppercase tracking-widest text-gray-400 bg-gray-50 px-2 py-1 rounded">
                          #{tag}
                        </span>
                      ))}
                    </div>
                  ...
                  <Link
                    ...
                    className="mt-auto inline-flex items-center gap-2 text-purple-600 hover:text-pink-600 font-black uppercase text-xs tracking-widest transition-colors group/link"
                  >
                    Read More
