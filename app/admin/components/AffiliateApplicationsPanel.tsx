...
export default function AffiliateApplicationsPanel() {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      setStatusMessage({ type: 'success', message: 'Application approved successfully! Email sent to applicant.' });
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
            ...
            <p className="text-sm text-gray-500 mb-6">
              The influencer account has already been created when they submitted the application. 
              You can now create promo codes for them from the "Promo Users" tab.
            </p>
