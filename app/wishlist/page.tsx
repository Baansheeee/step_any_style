    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-10 text-center">
          <h1 className="text-3xl sm:text-4xl font-black uppercase tracking-widest text-gray-900 mb-4">
            My Wishlist
          </h1>
        ...
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <Link 
              href="/products"
              className="px-8 py-3 bg-purple-600 text-white font-bold uppercase tracking-widest text-xs rounded-full hover:bg-purple-700 transition-colors shadow-lg shadow-purple-200"
            >
              Start Shopping
            </Link>
          </div>
              ...
              <div key={item.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all group border border-gray-100 relative flex flex-col">
                ...
                <div className="p-5 flex flex-col flex-1">
                  <Link href={`/products/${item.slug}`} className="group-hover:text-purple-600 transition-colors">
                    <h3 className="font-bold text-gray-900 uppercase tracking-wide text-sm line-clamp-1 mb-2">
                      {item.name}
                    </h3>
                  </Link>
                  ...
                  <Link 
                    ...
                    className="mt-4 w-full block text-center py-3 bg-gray-900 text-white text-xs font-bold uppercase tracking-widest hover:bg-purple-600 transition-colors"
                  >
                    View Product
                  </Link>
                </div>
